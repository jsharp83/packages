...
- (void)setLimitsNavigationsToAppBoundDomainsForConfigurationWithIdentifier:(NSNumber *)identifier isLimited:(NSNumber *)limit error:(FlutterError *_Nullable *_Nonnull)error;
...
- (void)setInspectableForWebViewWithIdentifier:(NSNumber *)identifier inspectable:(NSNumber *)inspectable error:(FlutterError *_Nullable *_Nonnull)error;
@end
...
- (void)runJavaScriptAlertPanelForDelegateWithIdentifier:(NSNumber *)identifier message:(NSString *)message completion:(void (^)(FlutterError *_Nullable))completion;
/// Callback to Dart function `WKUIDelegate.runJavaScriptConfirmPanelWithMessage`.
- (void)runJavaScriptConfirmPanelForDelegateWithIdentifier:(NSNumber *)identifier message:(NSString *)message completion:(void (^)(NSNumber *_Nullable, FlutterError *_Nullable))completion;
/// Callback to Dart function `WKUIDelegate.runJavaScriptTextInputPanelWithPrompt`.
- (void)runJavaScriptTextInputPanelForDelegateWithIdentifier:(NSNumber *)identifier prompt:(NSString *)prompt defaultText:(NSString *)defaultText completion:(void (^)(NSString *_Nullable, FlutterError *_Nullable))completion;
@end
